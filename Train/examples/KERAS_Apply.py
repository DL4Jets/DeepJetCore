...
predict_test_list = mymodel.predict([x_local, x_global])
...
predict_test_write = np.core.records.fromarrays(  predict_test.transpose(), 
                                             names=' estPT, probB, probC, probUDS, probG',
...
array2root(predict_test_write,inputModelDir+"KERAS_result_val.root",mode="recreate")
