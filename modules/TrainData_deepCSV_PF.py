...
class TrainData_deepCSV_microPF(TrainData_deepCSV_PF):
    ...
    def readFromRootFile(self,filename,TupleMeanStd, weighter):
        ...
        self.w=[weights]
        self.x=[x_global,x_npf,x_sv,x_global_csv]
        self.y=[alltruth]
...
class TrainData_deepConvCSV(TrainData_deepCSV_PF):
    '''
    classdocs
    '''
    ...
    def __init__(self):
        ...
        self.addBranches(['jet_pt', 'jet_eta','nCpfcand','npv'])
    ...
    def readFromRootFile(self,filename,TupleMeanStd, weighter):
        ...
        x_global = MeanNormZeroPad(filename,TupleMeanStd,
                                   self.branches[0:1],
                                   self.branchcutoffs[0:1],self.nsamples)
        ...
        x_c = MeanNormZeroPadParticles(filename,TupleMeanStd,
                                   self.branches[4],
                                   self.branchcutoffs[4],self.nsamples)
