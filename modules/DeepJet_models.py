...
def Dense_model_broad(Inputs,nclasses,Inputshapes,dropoutRate=-1):
    ...
    #gl = Dense(8, activation='relu',init='lecun_uniform',input_shape=Inputshapes[0])(Inputs[0])
    #gl = Dense(8, activation='relu',init='lecun_uniform')(gl)
    #gl = Dense(8, activation='relu',init='lecun_uniform')(gl)
    ...
    cpf  = Convolution1D(32, 1, init='lecun_uniform',  activation='relu')(cpf)
    cpf  = Convolution1D(32, 1, init='lecun_uniform',  activation='relu')(cpf)
    cpf  = Convolution1D(16, 1, init='lecun_uniform',  activation='relu')(cpf)
    cpf = Flatten()(cpf)
    ...
    npf = Convolution1D(16, 1, init='lecun_uniform',  activation='relu')(npf)
    npf = Convolution1D(8, 1, init='lecun_uniform',  activation='relu')(npf)
    npf = Flatten()(npf)
    
    vtx = Convolution1D(64, 1, init='lecun_uniform',  activation='relu',input_shape=Inputshapes[3])(Inputs[3])
    vtx = Dropout(dropoutRate)(vtx)
    vtx = Convolution1D(64, 1, init='lecun_uniform',  activation='relu')(vtx)
    vtx = Convolution1D(32, 1, init='lecun_uniform',  activation='relu')(vtx)
    vtx = Convolution1D(32, 1, init='lecun_uniform',  activation='relu')(vtx)
    vtx = Convolution1D(32, 1, init='lecun_uniform',  activation='relu')(vtx)
    vtx = Convolution1D(16, 1, init='lecun_uniform',  activation='relu')(vtx)
    vtx = Flatten()(vtx)
