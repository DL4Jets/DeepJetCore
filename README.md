...
**Note:** For the bleeding-edge version of the package please refer the [updated Documentation](https://github.com/SwapneelM/DeepJetCore/blob/python-package/PYPKG.md)
